...
const features = [
    {
        ...
        description:
            "Leverage digital integrated inventory management and controls solutions. Unify your supply chain, sales, procurement, and finance decision-making through robust inventory controls algorithms and frameworks, to drive strategies with execution excellence.",
        image: "./assets/improve.jpg",
        benefits: ["Robust data integration", "Modelling simulations & Optimization Tool", "Analytics with KPI dashboard", "Transparency, accuracy & speed"]
    },
    {
        title: "Commodities Risk Management",
        description:
            "Robust daily commodity positioning reporting and management solution. Connected product and material metadata with granular finance data to get full understanding of each material entity. Efficient analytics including predictive modeling to evaluate, report and manage commodity physical and financial risks & opportunities.",
    ...
    },
    {
        ...
        description:
            "Best-in-class supplier lifecycle management solution with end-to-end building blocks for strategic sourcing. Leveraging internal, supplier-led, and market intelligence, powered by Gen AI and Agentic AI, to drive segmentation, portfolio, performance management, optimize relationships, and deliver incremental value.",
        image: "./assets/stock.jpg",
        benefits: ["Supplier segmentation & positioning models",
    ...
    },
    {
        ...
        description:
            "Comprehensive and adaptable tariff assessment and management solution. Simple description-based tariff impact analysis of existing spend with scenario planning and alternative sourcing evaluation functionalities. Uses AI powered source discovery and analytics.",
        image: "./assets/collaborate.jpg",
        benefits: ["What-if analysis tools",
...
export default function FeatureSection() {
    ...
    return (
        ...
        //                 Transform Your <span className="text-gradient">Procurement & Supply Chain </span> Operations
        //             </h2>
        //             <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        //                 Leverage advanced AI/ML technologies to optimize core supply chain and procurement processes.
        //             </p>
        //         </div>
        ...
        //                                 <h3 className={`text-xl font-semibold transition-colors ${activeIndex === index ? "text-blue-700" : "text-gray-800"
        //                                     }`}>
        //                                     {feature.title}
        //                                 </h3>
        //                                 <ChevronDown
        //                                     className={`h-6 w-6 text-gray-500 transition-transform duration-300 ${activeIndex === index ? "rotate-180 text-blue-600" : "rotate-0"
        //                                         }`}
        //                                 />
        //                             </div>
