...
const features = [
    {
        ...
        description: (
            <>
                Leverage digital <strong>integrated inventory management and controls solutions. </strong>
                Unify your supply chain, sales, procurement, and finance decision-making through robust
                inventory controls algorithms and frameworks, to drive strategies with execution excellence.
            </>
        ),
    ...
    },
    {
        ...
        description: (
            <>
                Robust <strong>daily commodity positioning reporting and management solution.</strong> Connected product and material metadata with granular finance data to get full
                understanding of each material entity. Efficient analytics including predictive
                modeling to evaluate, report and manage commodity physical and financial risks & opportunities.
            </>
        ),
    ...
    },
    {
        ...
        description: (
            <>
                Best-in-class <strong>supplier lifecycle management solution</strong> with end-to-end
                building blocks for strategic sourcing. Leveraging internal, supplier-led, and market
                intelligence, powered by Gen AI and Agentic AI, to drive segmentation, portfolio,
                performance management, optimize relationships, and deliver incremental value.
            </>
        ),
    ...
    },
    {
        ...
        description: (
            <>
                Comprehensive and adaptable <strong>tariff assessment and management solution.</strong> Simple description-based tariff impact analysis of existing spend with scenario planning
                and alternative sourcing evaluation functionalities. Uses AI powered source discovery
                and analytics.
            </>
        ),
                                            ...
                                            <div className="grid grid-cols-2 gap-2 ">
                                                {feature.benefits.map((benefit, idx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-sm text-gray-700 leading-[12px]">
                                                            {benefit}
                                                        </span>
                                                    </div>
                                                ))}
