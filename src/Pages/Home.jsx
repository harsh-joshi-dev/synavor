                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                                ...
                                through Advanced AI/ML
                            </h1>

                            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                                Transform your procurement operations with data-driven insights, 
                                predictive analytics, and intelligent automation. Drive efficiency, 
                                reduce costs, and create sustainable value across your supply chain.
                            </p>
