...
const solutions = [
  {
    ...
    details:
      "Transform your inventory operations with advanced machine learning algorithms that predict demand patterns, optimize stock levels, and prevent costly stockouts. Our solution provides real-time visibility across all warehouses and distribution centers with automated reorder points and dynamic safety stock calculations.",
  ...
  },
  {
    ...
    details:
      "Comprehensive commodity risk management platform that provides real-time market intelligence, price forecasting, and risk assessment tools. Monitor global commodity markets, track price fluctuations, and make data-driven procurement decisions with advanced analytics and predictive modeling.",
  ...
  },
  {
    ...
    details:
      "Comprehensive supplier lifecycle management platform that streamlines vendor relationships, enhances performance tracking, and drives collaborative procurement processes. Strengthen supplier partnerships with transparent evaluations, automated scorecards, and AI-driven insights for continuous improvement.",
  ...
  },
  {
    ...
    details:
      "Comprehensive trade compliance solution that automates tariff classification, duty calculation, and regulatory compliance across multiple jurisdictions. Stay ahead of evolving international trade regulations with real-time updates, automated documentation, and intelligent compliance monitoring.",
  ...
  useEffect(() => {
    ...
    if (solutionParam !== null) {
      ...
      if (solutionIndex >= 0 && solutionIndex < solutions.length) {
        ...
        const solutionId = solution.name
          .toLowerCase()
          .replace(/\s+/g, "-")
          .replace(/&/g, "and");
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="gradient-bg section-padding">
        <div className="max-w-7xl mx-auto container-padding text-center">
          ...
          >
            Purpose-built Solutions Engineered
            <br />
          ...
          {solutions.map((solution, index) => {
            ...
            return (
              <motion.button
                ...
                className={`px-6 py-3 rounded-full text-sm font-normal transition-all duration-300 ${
                  isActive
      ...
      <AnimatePresence>
        {selectedSolution === "inventory-controls-and-management" && (
           <motion.section
             ref={(el) =>
               (sectionRefs.current["inventory-controls-and-management"] = el)
             }
             data-solution="inventory-controls-and-management"
                ...
                >
                  <div className="space-y-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                      Measure, Control and Optimize Inventory for savings,
                      efficiencies and resilience
                    </h1>
                    <p className="text-xl text-gray-600 leading-relaxed">
                      Enable smarter, data-driven decisions with
                      enterprise-grade controls, cutting-edge algorithms, and
                      AI/ML powered workflow solutions.
                    </p>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                  ...
                  >
                    <h3 className="text-lg font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                      Robust data integration across company's information
                      ecosystem
                    </h3>
      ...
      <AnimatePresence>
        {selectedSolution === "commodity-risk-management" && (
           <motion.section
             ref={(el) =>
               (sectionRefs.current["commodity-risk-management"] = el)
             }
             data-solution="commodity-risk-management"
             initial={{ opacity: 0, y: 50 }}
             animate={{ opacity: 1, y: 0 }}
             exit={{ opacity: 0, y: -50 }}
             transition={{ duration: 0.6 }}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  <div className="space-y-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                      Commodity Daily Positioning Management Platform for
                      Procurement and Finance teams
                    </h1>
                    <p className="text-xl text-gray-600 leading-relaxed">
                      Empower your teams with integrated, smarter, & nimble
                      solutions that are powered by complex analytics, AI/ML led
                      predictive modeling & industry tested workflows.
                    </p>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Intelligent agentic AI leveraged mapping to develop
                          coverage / exposure monitoring
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  ...
                  >
                    <h3 className="text-lg font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors duration-300">
                      Fuel critical decisions efficiently by supercharging your
                      data with right analytics
                    </h3>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Exhaustive and structured analytics to maximize value
                          of daily commodity hedges
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Scenario modelling and commodity price tracking for
                  ...
                  >
                    <h3 className="text-lg font-bold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors duration-300">
                      Seamless two-way integration with existing system
                      landscape
                    </h3>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Work-flow actions and ability to transfer information
                          in reports supports decision making and compliance
                          tasks
                        </span>
                      </li>
                      <li className="flex items-start">
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Advanced analytics and predictive modelling to enable
                          coverage decisions
                        </span>
                      </li>
                    </ul>
      ...
      <AnimatePresence>
        {selectedSolution === "supplier-segmentation-and-srm-support" && (
           <motion.section
             ref={(el) =>
               (sectionRefs.current["supplier-segmentation-and-srm-support"] =
                 el)
             }
             data-solution="supplier-segmentation-and-srm-support"
             initial={{ opacity: 0, y: 50 }}
             animate={{ opacity: 1, y: 0 }}
             exit={{ opacity: 0, y: -50 }}
             transition={{ duration: 0.6 }}
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  <div className="space-y-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
                      Unlock competitive advantage through effective supplier
                      management across the full life cycle
                    </h1>
                    <p className="text-xl text-gray-600 leading-relaxed">
                      Monetize longest phase of supplier's relationship, and
                      drive value aligned with business objective through
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          AI powered spend analytics and categorization with
                          actionable insights
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Best in class segmentation framework powered by
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Comprehensive supplier performance tracking and
                          evaluation
                        </span>
                      </li>
                      <li className="flex items-start">
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Advanced risk assessment and monitoring capabilities
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Proactive risk mitigation strategies and alerts
                        </span>
                      </li>
                    </ul>
                  </motion.div>
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Portfolio management, interaction models and SRM
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Enable communication, change management and tracking
                          using actionable features
                        </span>
                      </li>
                    </ul>
                  </motion.div>
      ...
      <AnimatePresence>
        {selectedSolution === "tariff-impact-management" && (
           <motion.section
             ...
             data-solution="tariff-impact-management"
             initial={{ opacity: 0, y: 50 }}
             animate={{ opacity: 1, y: 0 }}
             exit={{ opacity: 0, y: -50 }}
             transition={{ duration: 0.6 }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  <div className="space-y-8">
                    ...
                    <p className="text-xl text-gray-600 leading-relaxed">
                      Effortlessly manage tariff risk seamlessly with impact
                      overview, scenario based "What-if" analysis and mitigate
                      using trade options through AI enabled solutions.
                    </p>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Description based tariff impact analysis for given
                          spend powered by AI enabled search
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Industry news, predictive spend review and categorized
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Best alternative to existing impact available through
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Full visibility to control and determine optional
                          benefits with visibility and control on calculation
                          methodologies
                        </span>
                      </li>
                    </ul>
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Flexible scenario analysis using multiple variable
                          inputs to estimate potential impact
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Seamless information and communication enablement
                          through exportable and built in reports
                        </span>
                      </li>
                    </ul>
                  </motion.div>
                  ...
                  >
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Actionable workflows and an ability to export and
                          report analytics for impact management
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span>
                          Executive reporting for leadership and risk committees
                          built in
                        </span>
                      </li>
                    </ul>
